...
//   zooanimals.includes(animalName);
//   animalOutput.textContent = hasAnimal
//     ? `Yes., ${animalName} is included.`
//     : `No., ${animalName} is not included.`;
//   //
//   return null;
// }

// // von Elisabeth - case sensitive:
// selber verstehen!
//
// function hasAnimal(animals, animalName) {
//   return animals.includes(animalName);
// }
// // console.log("Does it include? ", hasAnimal.value);
...
// von Elisabeth - nicht case sensitive:
// selber verstehen!
//
function hasAnimal(animals, animalName) {
